...
let introduction = `My name is ${firstName} ${lastName}, and I think ${luckyNumber
} is a winner!`
...
//     Console log the value of `friendsPets`
let friendsPets = 3;
...
//      console.log the result after the ternary has run.
